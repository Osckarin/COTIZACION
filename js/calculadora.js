...
/*
 * Clic en la orientacion Vertical
 */
    $('#orientacion_v').click(function(e) {
        ...
        if(validarForma() === 1){
            ...
            clearCanvas();
            $("#micanvas").attr({width: h * escala, height: b * escala, style: "background-color: #FFF9A1;"});
 ...
 */
    $('#orientacion_h').click(function(e) {
        ...
        if(validarForma() === 1){
            ...
            clearCanvas();
            $("#micanvas").attr({width: b * escala, height: h * escala, style: "background-color: #FFF9A1;"});
...
function imprimirResultados(cortes_pliego, pliegos, cortes, cortesH, cortesV, utilizables) {
    ...
    $("#cliente").text((pliegos*0.8)*2);
    $("#empresa").text((pliegos*0.8));
}
